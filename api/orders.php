    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="save-order-changes" disabled>Сохранить изменения</button>
            </div>
        </div>
    </div>
</div>
    ...
    function renderOrderDetails(orderData) {
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select status-select" id="order-status">
                                        ...
                                        <option value="processing" ${orderData.order.status === 'processing' ? 'selected' : ''}>В обработке</option>
        ...
        if (trackingInput) {
            trackingInput.addEventListener('input', () => {
                ...
                // Suggest 'shipped' only if status is 'new' or 'processing' and tracking number is entered
                if (trackingNumber && (currentStatus === 'new' || currentStatus === 'processing')) {
