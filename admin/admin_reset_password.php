    ...
    try {
        ...
        if (!$reset || (time() - strtotime($reset['created_at']) > 3600)) {
            ...
            try {
                ...
                $pdo->commit();
                $success = 'Пароль успешно изменен. Теперь вы можете войти в админ-панель.';
                logActivity($pdo, 'admin_password_reset', "Пароль успешно сброшен для админа с email $email", null);
...
<head>
    ...
    <title>Сброс пароля админа | Pnevmatpro.ru</title>
    ...
    <div class="login-card">
        ...
        <?php if ($error): ?>
            ...
            <div class="text-center mt-3">
                <a href="/admin/admin_reset_password.php" class="btn btn-secondary w-100 py-2">
        ...
        <?php if ($success): ?>
            ...
            <div class="text-center mt-3">
                <a href="/admin" class="btn btn-primary w-100 py-2">
